...
torchrun --standalone --nproc_per_node=4 --master_port=13456 tests/test_accept_new.py --target_group 0 1 2 3 --draft_group 0 1 2 3 --T 0.6 --P 0.9 --M 256 --W 31 --dataset cnn --dst new-7b-70b-acc.pt --compile
